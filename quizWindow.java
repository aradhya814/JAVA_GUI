...
public class quizWindow extends JFrame implements ActionListener{
	...
	quizWindow(String name)
	{
        ...
        Userinfo.setText(
			"<html>"+
				"Student Detials" + "<br>" +
				"Name: "+username + "<br>" +
				"Registration Number: 220968034" + "<br>" +
			 "<html>"
        		);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==next)
		{
			...
			else
			{
				int ans=JOptionPane.showConfirmDialog(null,"Once pressed next, you cannot go back?\nDo You "
						+ "Want to Continue","Submit Answer",JOptionPane.YES_NO_OPTION);
		...
		if(e.getSource()==submit)
		{
			...
			{
				int subans=JOptionPane.showConfirmDialog(null,"Do You Want to Submit the quiz","Submit Answer"
